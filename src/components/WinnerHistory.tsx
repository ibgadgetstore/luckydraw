          ...
          {history.length > 0 && (
            <>
              ...
              <button
                id="btn-export-csv"
                onClick={exportToCSV}
                className="px-3.5 py-2 rounded-xl text-xs font-bold bg-[#8B5CF6] hover:bg-[#7C3AED] text-white flex items-center gap-1.5 transition-colors shadow-sm"
              ...
              <button
                ...
                title="Hapus semua riwayat pemenang"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-150">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="text-sm font-bold font-serif">Hapus Semua Riwayat?</h4>
