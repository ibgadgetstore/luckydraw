  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 pb-4 border-b ${isDark ? 'border-white/10' : 'border-slate-100'}`}>
        <div>
          <h3 className={`text-base sm:text-lg font-serif font-bold flex items-center gap-2 ${isDark ? 'text-white' : 'text-slate-900'}`}>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-150">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="text-sm font-bold font-serif">Kosongkan Semua Hadiah?</h4>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-150">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h4 className="text-sm font-bold font-serif">Reset ke Hadiah Standar?</h4>
                <p className={`text-xs ${isDark ? 'text-white/60' : 'text-slate-500'}`}>
